                ...
                if (actions != null) {
                    ...
                    if (AppUtils.isMediaNotification(notification)) {
                        ...
                        for (action in actions) {
                            ...
                            val matColor = ColorUtils.getMainColors(sharedPreferences, this)[0]
                            actionTv.setTextColor(ColorUtils.manipulateColor(matColor, 1.6f))
                ...
                notificationLayout.animate()
                    ...
                    .setListener(object : AnimatorListenerAdapter() {
                        override fun onAnimationEnd(animation: Animator) {
                            notificationLayout.setLayerType(View.LAYER_TYPE_NONE, null)
                        }
                    })
        ...
        handler.postDelayed({
            ...
            notificationLayout.animate()
                ...
                .setListener(object : AnimatorListenerAdapter() {
                    override fun onAnimationEnd(animation: Animator) {
                        notificationLayout.visibility = View.GONE
                        notificationLayout.scaleX = 1f; notificationLayout.scaleY = 1f
